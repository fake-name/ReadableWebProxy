def extractReLibrary(item):
	...
	tagmap = [
		...
		('i am succubus!',                         'i am succubus!',                                                         'oel'),
		...
		('song of adolescence',                    'song of adolescence',                                                    'translated'),
		...
		('worlds unknown',                         'Worlds Unknown: The Enlightened',                                        'oel'),
		('loli elf',                               'Loli Elf & Her Happy Life',                                              'translated'),
		('my loli brother',                        'my loli brother',                                                        'translated'),
		('devil\'s evolution catalog',                               'The Devil\'s Evolution Catalog',                                                               'translated'),
