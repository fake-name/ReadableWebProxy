def extractWuxiaworld(item):
	...
	tagmap = [
		...
		('the attack of the wastrel',                       'the attack of the wastrel',                         'translated'),
		...
		('immortal devil transformation',                   'immortal devil transformation',                     'translated'),
		('poison physician consort',                        'poison physician consort',                          'translated'),
		('the underworld detective',                        'the underworld detective',                          'translated'),
		('love code at the end of the world',               'love code at the end of the world',                 'translated'),
		('otherworldly merchant',                           'otherworldly merchant',                             'translated'),
		('soul land 3: legend of the dragon king',          'Douluo Dalu 3: Legend of the Dragon King',          'translated'),
		('netherworld investigator',                        'netherworld investigator',                          'translated'),
