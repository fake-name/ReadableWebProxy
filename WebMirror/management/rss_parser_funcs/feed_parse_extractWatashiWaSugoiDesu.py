def extractWatashiWaSugoiDesu(item):
	...
	tagmap = [
		...
		('Corporate Slave',                                 'Money makes the (Other) World Go Round: The Corporate Slave Dragged into the Saint Summoning',                  'translated'),
		('undead sage',                                     'The Executed Sage Reincarnates as a Lich and Begins a War of Aggression',                                       'translated'),
		('tensei saki de suterareta',                       'Tensei Saki de Suterareta no de, Mofumofu Tachi to Oryouri Shimasu ~Okazari Ouhi wa my Pace ni Saikyou Desu~',  'translated'),
