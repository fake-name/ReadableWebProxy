def extractFoxaholicWordpressCom(item):
	...
	tagmap = [
		...
		('cute beast world: beast husband, memeda!',                                                'cute beast world: beast husband, memeda!',                                                               'translated'),
		('overturn the entertainment circle',                                                       'overturn the entertainment circle',                                                                      'translated'),
		('full of nectar',                                                                          'full of nectar',                                                                                         'translated'),
