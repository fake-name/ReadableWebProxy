def extractAthenatlsCom(item):
	...
	tagmap = [
		...
		('tdk',                                                                                  'The Demon King Of The Frontier Life, Reincarnated To Become The Strongest Mage ~The Former Demon King Who Grows Up While Being Loved Wants To Know The Human~',     'translated'),
		...
		('tus',                                                                                  'The Unsuccessful Yet Academically Unparalleled Sage ~A Cheating S-Rank Sorcerer’s Post-Rebirth Adventurer Log~',                      'translated'),
		('PRC',       'PRC',                      'translated'),
