def extractLightNovelsTranslations(item):
	...
	tagmap = [
		...
		('high school hack and slash',                                                 'High School Hack and Slash',                                                               'translated'),
		('rising of tanaka',                                                           'The Rising of Tanaka',                                                                     'translated'),
		('Gosick',                                                                     'Gosick',                                                                                   'translated'),
		('soot-steeped knight',                                                        'Soot-Steeped Knight',                                                                      'translated'),
		('b.a.d',                                                                      'B.A.D.',                                                                                   'translated'),
		('ex-hero, now freeloader',                                                    'Ex-Hero, Now Freeloader',                                                                  'translated'),
